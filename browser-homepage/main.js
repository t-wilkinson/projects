...
var $author$project$Main$color = {
	accent: A3($mdgriffith$elm_ui$Element$rgb255, 189, 147, 249),
	background: A3($mdgriffith$elm_ui$Element$rgb255, 40, 42, 54),
	black: A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0),
	blue: A3($mdgriffith$elm_ui$Element$rgb255, 139, 233, 253),
	subAccent: A3($mdgriffith$elm_ui$Element$rgb255, 98, 114, 164)
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$color($author$project$Main$color.blue)
					]),
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$color($author$project$Main$color.accent)
					]),
				$mdgriffith$elm_ui$Element$text('Trey'))
			]));
};
...
var $author$project$Main$sites = function (model) {
	var img = function (name) {
		return A2(
			...
			{description: name, src: 'icons/' + (name + '.svg')});
	};
	return A2(
		$mdgriffith$elm_ui$Element$wrappedRow,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$moveUp(90),
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color($author$project$Main$color.background),
				$mdgriffith$elm_ui$Element$Font$family(
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$typeface('Pincoya')
					]))
			]),
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$sites(model)
				])));
};
