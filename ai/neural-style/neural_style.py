...
def run(content_image, style_image, output_image):
...
# desired size of the output image
    ...
    size, style_image = image_loader(style_image)
    _, content_image = image_loader(content_image, size)
...
### Run the algorithm ###
    ...
    utils.save_image(output, output_image)
...
if __name__ == '__main__':
    ...
    run(args.content_image, args.style_image, args.output_image)
