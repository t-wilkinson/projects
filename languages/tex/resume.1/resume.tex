...
\begin{tabular}{l r} % Enables tabbing
\vbox{
    {\huge{\color{purple}\textbf{Trey Wilkinson}}} \newline
    {\huge{Full-stack Software Developer}}
}
& \vline \parbox{0.5\textwidth}{treywilkinson.xyz \newline hello@treywilkinson.xyz\newline github.com/t-wilkinson\newline}
\end{tabular}
{Driven and focused. Intense desire to learn and create.}\\
...
\section{Skills}
\begin{itemize}
\item Back-end: Haskell, node.js, Nginx, PostgreSQL, Stripe
\item Front-end: React, TypeScript, JavaScript, RxJs, Elm, Sass
\item DevOps: nix, git, ssh, linux
\item Also experienced in: C, C++, Python, Clojure, ClojureScript
\end{itemize}

\section{Interests}
\begin{itemize}
\item Pure Math: $\infty$-Category Theory, Homotopy Type Theory
\item Analytical Math: Calculus, Linear Algebra
\item Theoretical Computer Science: Automata, Type Theory
\item Physics: Theoretical and just knowing how the world works in general
\item Art: painting, drawing, visualization and simulations of various phenomenon
\end{itemize}

\section{Ahh what do I capitalize}
