...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-size', type=int, default=512 if torch.cuda.is_available() else 64)
    ...
    parser.add_argument('--style-weight', default=100_000, type=int)
    parser.add_argument('--content-weight', default=1, type=int)
